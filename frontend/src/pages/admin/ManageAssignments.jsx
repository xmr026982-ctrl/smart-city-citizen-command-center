  ...
  return (
    <main className="page-stack">
      <PageHeader
        ...
        description="Route open tickets to field staff. First assignment also acknowledges the report."
      />
      <div style={{ display: "grid", gap: 12 }}>
        {issues.map((issue) => (
          <article key={issue.id} className="panel" style={{ padding: 16, display: "flex", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
            <div>
