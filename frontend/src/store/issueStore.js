...
const seed = [
  {
    ...
    category: "lighting",
    location: "Near the park gate, beside the tram line",
    ward: "Ballygunge",
    lat: 22.527,
    lng: 88.363,
    photos: [],
  ...
  },
  {
    ...
    category: "water",
    location: "Opposite the Writer's Building approach",
    ward: "B.B.D. Bagh",
    lat: 22.5726,
    lng: 88.349,
    photos: [],
  ...
  },
  {
    ...
    category: "waste",
    location: "Behind the book market lane",
    ward: "College Street",
    lat: 22.576,
    lng: 88.3635,
    photos: [],
  ...
  {
    id: "ISS-2410",
    title: "Pothole cluster near Esplanade crossing",
    description: "Five deep potholes are slowing peak-hour traffic.",
    category: "roads",
    location: "Esplanade crossing, Dharmatala",
    ward: "Dharmatala",
    lat: 22.5604,
    lng: 88.3519,
    photos: [],
